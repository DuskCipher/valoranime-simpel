        ...
        <div className="container mx-auto px-4 lg:px-8 h-16 flex items-center justify-between">
          <div className="flex items-center gap-6">
            ...
            <div className="hidden md:flex items-center gap-6 text-sm font-medium h-full">
              ...
              <Link href="/library" className="text-zinc-600 dark:text-zinc-300 hover:text-amber-600 dark:hover:text-amber-500 transition-colors font-medium py-4">Perpustakaan</Link>
            </div>
          </div>
      ...
      >
        ...
        <div style={{ overflowY: 'auto', height: 'calc(100dvh - 65px)' }}>
          ...
          <div className="flex flex-col">
            ...
            <Link href="/library" onClick={() => setMenuOpen(false)} className="px-5 py-4 font-bold text-[13px] text-amber-500 hover:text-amber-400 transition-colors">Perpustakaan Saya</Link>
          </div>
